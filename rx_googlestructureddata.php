...
class Rx_googlestructureddata extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->defaults = array(
            ...
            $this->mod_prefix.'LOCALBUSINESS_DESC' , '',
            $this->mod_prefix.'LOCALBUSINESS_VAT'  , '',
            $this->mod_prefix.'LOCALBUSINESS_PHONE'  , '',
            $this->mod_prefix.'LOCALBUSINESS_PRANGE_SHOW'  , '',
            $this->mod_prefix.'LOCALBUSINESS_STREET' , '',
            $this->mod_prefix.'LOCALBUSINESS_COUNTRY'  , '',
            $this->mod_prefix.'LOCALBUSINESS_REGION'  , '',
            $this->mod_prefix.'LOCALBUSINESS_CODE'  , '',
            $this->mod_prefix.'LOCALBUSINESS_LOCALITY' , '',
        );
    }
    ...
    public function hookdisplayBeforeBodyClosingTag()
    {
        ...
        if ($results = Db::getInstance()->ExecuteS($sql)) {
            foreach ($results as $row)
                $priceRange = round( $row['min_price'], 2) . "-" . round( $row['max_price'], 2);
        }
        ...
        $vars = [
            ...
            'localbusiness_show' 		=> (bool)Configuration::get($this->mod_prefix.'SHOW_LOCALBUSINESS'),
            ...
            'localbusiness_pricerange_show'	=> (bool)Configuration::get($this->mod_prefix.'LOCALBUSINESS_PRANGE_SHOW'),
            'localbusiness_pricerange'	=> $priceRange,
            'localbusiness_gps_show'	=> (bool)Configuration::get($this->mod_prefix.'LOCALBUSINESS_GPS_SHOW'),
